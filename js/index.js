...
const TEXTS = {
    about: `<pre class="welcome-ascii-art"> _   _      ___            _  _\n| |_| |__  / _ \\ _ __ ___ | || |  ___ \n| __| '_ \\| | | | '_ \` _ \\| || |_/ __|\n| |_| | | | |_| | | | | | |__   _\\__ \\\n \\__|_| |_|\\___/|_| |_| |_|  |_| |___/</pre><b>Welcome to my portfolio!</b>\n
        Hello, I am Thomas LEDOS, a ${age}-year old student in Engineering at <a target="_blank" href="https://esilv.fr/en/">ESILV</a> near Paris, majoring in <i>Internet of Things and Cybersecurity</i>. I am currently looking for a 4-5 months internship starting in April 2024 working in networks, embedded devices or cybersecurity.\n
